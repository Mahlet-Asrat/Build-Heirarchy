import { useAddAnyPos } from "./useAddAny";


const AddAnyPositionForm = () => {
    console.log("Rendering AddAnyPositionForm");

    const { register, handleSubmit, onSubmit, errors, isSubmitting, serverError, success, validParents, isLoading } = useAddAnyPos();

    console.log("Parents", validParents);
...
export default AddAnyPositionForm;
